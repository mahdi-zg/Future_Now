...
INSERT INTO `users` (`id`, `address`, `code_postal`, `email`, `first_name`, `last_name`, `password`, `pays`, `phone_number`, `user_role`) VALUES
(1, NULL, NULL, 'admin@test.com', 'Admin', 'Account', '$2a$10$YX0NbimfWWuuchwOSRK84O10/swj34JymRcbjfBFy69Qhhls6zFbS', NULL, NULL, 0);
